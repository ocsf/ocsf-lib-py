...
def get_repo():
    ...
    r["extensions/windows/extension.json"] = DefinitionFile("extensions/windows/extension.json", data=ExtensionDefn(name="win"))
    r["extensions/linux/extension.json"] = DefinitionFile("extensions/linux/extension.json", data=ExtensionDefn(name="linux"))
    r["extensions/linux/objects/process.json"] = DefinitionFile("extensions/linux/objects/process.json", data=ObjectDefn(name="process"))
    r["extensions/windows/events/reg_key.json"] = DefinitionFile("extensions/windows/events/reg_key.json", data=EventDefn(name="reg_key_activity"))
    r["extensions/windows/profiles/red.json"] = DefinitionFile("extensions/windows/profiles/red.json", data=ProfileDefn(name="red"))
