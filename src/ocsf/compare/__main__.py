...
def main():
    ...
    parser.add_argument("--expand-changes", dest="collapse_changes", action="store_false", help="Expand changes as separate rows prefixed with +/- (default: collapse changes)")
    parser.add_argument("--collapse-changes", dest="collapse_changes", action="store_true", help="Show changes as a single row prefixed with ~ (default)")
